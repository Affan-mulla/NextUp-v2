            ...
            <DropdownMenu onOpenChange={setIsOpen}>
                <div className="group relative">
                    ...
                    <DropdownMenuContent
                        align="end"
                        sideOffset={4}
                        className="w-64 p-2 bg-background backdrop-blur-sm border border-border rounded-2xl shadow-xl shadow-zinc-900/5 dark:shadow-zinc-950/20 
                        ...
                        <div className="space-y-1">
                            {menuItems.map((item) => (
                                <DropdownMenuItem key={item.label} asChild>
                                    <Link
                                        href={item.href}
                                        className="flex items-center p-3 hover:bg-zinc-100/80 dark:hover:bg-zinc-800/60 rounded transition-all duration-200 cursor-pointer group hover:shadow-sm border border-transparent hover:border-zinc-200/50 dark:hover:border-zinc-700/50"
                                    >
